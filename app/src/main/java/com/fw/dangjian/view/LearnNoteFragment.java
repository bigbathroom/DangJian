...
public class LearnNoteFragment extends  BaseFragment implements LearnNoteMvpView{
    ...
    protected View fillView() {
        return layoutinflater.inflate(R.layout.fragment_learn_note, null);
    }
    ...
    private void changeNote(String s, int id) {
        userPresenter.changeLearnNote(managerId, id, s, this);
    }

    private void requestServer(int page) {
        userPresenter.getLearnNote(managerId, this);
    }
