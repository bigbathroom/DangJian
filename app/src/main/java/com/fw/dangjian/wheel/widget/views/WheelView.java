...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xeeffffff, 0xeaffffff, 0x55ffffff };
//	private static final int[] SHADOWS_COLORS = new int[] { 0xffffff, 0xeaffffff, 0x33ffffff };
